...
Katalog default sengaja memakai data produk asli dan tidak menjadikan Ostracism sebagai nama produk. Tambahkan nama produk, harga, stok, dan URL/path foto produk asli melalui dashboard admin. Jika belum ada foto resmi, storefront akan menampilkan empty state dan tidak memakai gambar dummy.
